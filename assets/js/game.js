...
var fight = function(enemy) {
  ...
  while (playerInfo.health > 0 && pickedEnemyObj.health > 0) {
    ...
    console.log(
      playerInfo.name + ' attacked ' + enemy.name + '. ' + enemy.name + ' now has ' + pickedEnemyObj.health + ' health remaining.'
    );
    ...
    if (pickedEnemyObj.health <= 0) {
      ...
      window.alert(enemy.name + ' still has ' + pickedEnemyObj.health + ' health left.');
    }
